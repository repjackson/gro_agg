if Meteor.isClient
    Template.registerHelper 'delta_kv_is', (key, value) ->
        # console.log 'key', key
    ...
    Template.registerHelper 'cd', () -> Docs.findOne model:'delta'
        ...
        sorted_facets: ->
            cd =
                Docs.findOne
                    model:'delta'
            if cd
                # console.log _.sortBy cd.facets,'rank'
                _.sortBy cd.facets,'rank'
